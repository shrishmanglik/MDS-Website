...
export const metadata: Metadata = {
  ...
  description:
    'We build AI that works. Production AI systems for businesses — not prototypes, not demos. Custom AI builds, SaaS products, and enterprise systems.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'We build AI that works. Production AI systems for businesses — not prototypes, not demos.',
    images: [
  ...
  return (
    <html lang="en" className="bg-[#0A0A0F]">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Sora:wght@400;600;700;800&family=JetBrains+Mono:wght@400;500;700&display=swap"
          rel="stylesheet"
        />
      </head>
