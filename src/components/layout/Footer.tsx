        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-text-secondary text-sm leading-relaxed max-w-xs">
              {SITE.tagline} We design, build, and deploy production AI systems.
            </p>
          </div>

          {/* Studio */}
          <div>
            <h4 className="font-heading font-semibold text-text-primary mb-4 text-xs uppercase tracking-[0.15em]">
              Studio
            </h4>
            <ul className="space-y-2.5">
              {STUDIO_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-text-secondary hover:text-accent-gold transition-all duration-200 hover:translate-x-0.5 inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mb-4">
              <a
                ...
                className="text-text-tertiary hover:text-accent-gold transition-colors p-2"
              >
