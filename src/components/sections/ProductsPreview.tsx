...
const productAccents: Record<string, { border: string; glow: string; bg: string }> = {
  pathway: { border: 'border-accent-blue/30', glow: 'shadow-[0_0_40px_rgba(41,98,255,0.08)]', bg: 'from-accent-blue/5' },
      ...
      <div className="max-w-content mx-auto relative">
        ...
        <div className="space-y-6">
          {featuredProducts.map((product, index) => {
            const accent = productAccents[product.slug] || productAccents.pathway
            return (
              <motion.div
                key={product.slug}
