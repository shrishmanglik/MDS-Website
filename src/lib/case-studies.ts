...
export const caseStudies: CaseStudy[] = [
  {
    ...
    approach: [
      ...
      'Built 10 scoring engines: answer key matching, rubric mapping, grammar rule engine, vocabulary scorer, pronunciation via Web Speech API, CLB level calculator, CRS points calculator, PNP matcher, progress tracker, and composite score aggregator',
      'Migrated 1,500+ practice items into structured data format with pre-computed answer keys and scoring rubrics',
      'Prepared for deployment on Vercel with Supabase backend — target infrastructure cost: $0/month on free tiers',
    ],
    results: [
      { metric: '25+ AI calls eliminated', description: 'Every scoring interaction now runs on deterministic engines — zero API calls at runtime' },
      { metric: '$0 runtime cost', description: 'All scoring, grading, and feedback generated without any AI API calls' },
      { metric: '1,500+ practice items', description: 'Complete TEF Canada coverage across all four exam sections' },
      { metric: 'Built and verified', description: 'Rebuild complete, all scoring engines tested, launching April 2026' },
    ],
    timeline: 'Rebuild from AI prototype to deterministic system',
    techUsed: ['Vite', 'React 19', 'TypeScript', 'Web Speech API', 'Supabase', 'Stripe', 'Vercel'],
    insight: {
  ...
  },
  {
    ...
    industry: 'Education',
    label: 'BUILD LOG · PREPAI STUDIO',
    title: 'PrepAI Studio: 130 Tests, Zero Failures, One Architecture',
    subtitle: 'JEE/NEET chemistry prep with exam-accurate paper generation. Blueprint engine + FSRS spaced repetition. Complete exam papers from pre-validated question bank. Starts with Chemistry, extends to every subject.',
